...
for entryNum in range(eventNum):
	...
	bannedLLPs = [] #Same deal but with indices within the gen tree corresponding to LLPs
	...
	for i in range(len(obj)):
		...
		if i not in bannedParts: #Identifies highest avaiable pT particle to use as seed
			...
			#Add in final value to indicate if particle is matched (1) or unmatched (0) to a gen LLPs by looking for LLPs within deltaR<0.4 of jet
			jetPartList.append(0)
